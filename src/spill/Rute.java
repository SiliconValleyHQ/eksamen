...
public class Rute extends Canvas implements Serializable {
	...
	protected bakgrunnsFarge getBackgroundColor() {
		return this.bakgrunnsFarge;
	}

	/** Hent brikken som okkuperer ruten */
	protected Brikke getOkkupant() {
		if (this.erOkkupert()) {
	 ...
	 *
	 * @param utforUtheving
	 * 		Om ruten skal utheves eller ikke
	 */
	protected void setUtheving(boolean utforUtheving) {
	 ...
	 *
	 * @param besokende
	 * 		Brikken som nå er i ruten
	 */
	protected void setOkkupant(Brikke besokende) {
		if (besokende != null) {
