...
public class Rute extends Canvas implements Serializable {
	 ...
	 * 		fargen til ruten
	 */
	Rute(bakgrunnsFarge fargen, int minRad, int minKolonne) {
		this.setSize(64, 64);
	...
	bakgrunnsFarge getBackgroundColor() {
	 ...
	 */
	void setUtheving(boolean utforUtheving) {
	 ...
	 */
	void setOkkupant(Brikke besokende) {
		if (besokende != null) {
