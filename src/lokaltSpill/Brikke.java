...
public class Brikke implements Serializable {
	 ...
	 */
	Brikke(Color farge, int rad, int kolonne) {
		this.farge = farge;
		this.rad = rad;
	 ...
	 */
	void setLokasjon(int rad, int kolonne) {
		this.rad = rad;
		this.kolonne = kolonne;
	}
	...
	public String toString() {
		...
		s.append("brikke på rad ").append(Integer.toString(this.getRad())).append(", kolonne ").append(Integer.toString(this.getKolonne()));
		return s.toString();
	}
